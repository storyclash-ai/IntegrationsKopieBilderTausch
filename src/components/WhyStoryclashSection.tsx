const DataFlowIllustration = () => (
  <div className="relative w-full h-full flex items-start justify-start pl-8" style={{ paddingTop: '10px' }}>
    <img
      ...
      style={{ maxHeight: '500px', transform: 'scale(1.0)', opacity: '0.1' }}
    />
  </div>
);
...
const benefits = [
  {
    ...
    description: 'No manual exports or spreadsheets. Storyclash delivers ready-to-use influencer and campaign data directly into your Power BI environment - clean, standardized, and automated.'
  },
  {
    icon: EnterpriseIcon,
  ...
  },
  {
    ...
    description: 'Combine influencer engagement and sales performance inside Power BI to visualize what truly drives business impact - with full transparency and zero guesswork.'
  }
];

export default function WhyStoryclashSection() {
  return (
