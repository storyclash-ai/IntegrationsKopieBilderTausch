...
const useCases = [
  {
    icon: ROIIcon,
    text: 'Combine influencer ROI with ad spend and sales KPIs'
  },
  {
    icon: TrendsIcon,
    text: 'Detect trends, top-performing creators, and wasted spend'
  },
  {
    icon: ShareIcon,
    text: 'Share dashboards company-wide with real-time updates'
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="mb-4" style={{ fontSize: '36px', lineHeight: '1', fontWeight: '600', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            From Social Data to Actionable Insights
          </h2>
          <p className="max-w-3xl mx-auto" style={{ fontSize: '16px', lineHeight: '1.3', fontWeight: '400', color: '#333333', fontFamily: 'Roboto, sans-serif' }}>
            Integrate Storyclash with Microsoft Power BI to connect influencer data with every marketing KPI that matters - sales, traffic, CRM.
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="p-4" style={{ borderRadius: '20px' }}>
